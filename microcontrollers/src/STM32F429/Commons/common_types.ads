...
package Common_Types is
   ...
   type Job is
      record
         Payload : Interfaces.Unsigned_32;
      end record;

   function Are_Jobs_Equal (J1, J2 : Common_Types.Job) return Boolean is (J1.Payload = J2.Payload);

   package Job_Lists is
     new Ada.Containers.Doubly_Linked_Lists (Element_Type => Common_Types.Job,
                                             "=" => Are_Jobs_Equal);
end Common_Types;
